...
Tags: Smart Brands for WooCommerce, woocommerce, woocommerce brands, woocommerce product, woocommerce manufacturer, woocommerce supplier, e-commerce, brands for products, supplier, product brand, wc brands, wc product brands, wc showcase brands, brand page, widget, plugin, brands plugin, brands widget, brands slider, slider with brands, showcase brands, page for brands, brands page plugin, brands images display
...
Boost sales by displaying WooCommerce Products Brands in your store. highly adaptable. No coding is necessary!

== Description ==

[__Live Demo__](https://demo.shapedplugin.com/smart-brands-for-woocommerce/) | [__Documentation__](https://docs.shapedplugin.com/docs/smart-brands-for-woocommerce/overview/) | [__Support__](https://shapedplugin.com/support/)
...
1. Live Demo
2. Add New Brand
3. Assign Brand to Products
4. Brands Archive Page
5. Create Brand Carousel
6. General Options
7. Display Options
8. Carousel Controls
9. Basic Settings
10. Product Page Settings
11. Loop Page Settings
12. Custom CSS
